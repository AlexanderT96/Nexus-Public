...
for(const value of ['src/autonomous-assistant.js','autonomous-assistant.css','v4.32.0-autonomous-v20'])requireText(worker,value,`service worker missing ${value}`);
requireText(config,"app: '4.32.0'",'app version not bumped to 4.32.0');
