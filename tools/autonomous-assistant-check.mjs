...
for(const value of ['src/autonomous-assistant.js','autonomous-assistant.css','v4.32.3-autonomous-v20'])requireText(worker,value,`service worker missing ${value}`);
requireText(config,"app: '4.32.3'",'app version not bumped to 4.32.3');
...
requireText(app,"typeof state!=='undefined'&&state.currentTab!=='dashboard'",'assistant does not read the global lexical workspace state');
